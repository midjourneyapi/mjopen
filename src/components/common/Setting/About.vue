  ...
  <NSpin :show="loading">
    <div class="p-4 space-y-4">
      <h2 class="text-xl font-bold">
        Version - {{ pkg.version }}
        <a v-if=" isShow " class="text-red-500" href="https://github.com/midjourneyapi/mjopen" target="_blank"> ({{ $t('mj.findVersion') }} {{ st.lastVersion }})</a>
        <a v-else-if="st.lastVersion" class="text-gray-500" href="https://github.com/midjourneyapi/mjopen" target="_blank"> ({{ $t('mj.yesLastVersion') }})</a>
      </h2>
